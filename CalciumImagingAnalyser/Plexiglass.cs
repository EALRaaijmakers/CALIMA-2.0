...
class Plexiglass : Form {
	public Plexiglass(Form tocover) {
		...
		this.Opacity = 1f;//0.30;      // Tweak as desired
		...
		pb.Width = DisplayRectangle.Width;
		pb.Height = DisplayRectangle.Height;
		//Controls.Add (pb);
		pb.Image = Image.FromFile ("graphs.png");
		pb.BackColor = Color.Transparent;

		this.BackgroundImage = pb.Image;
